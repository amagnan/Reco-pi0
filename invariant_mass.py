...
# Plot histograms for invariant mass(MeV) and DR.
...
# Count the number of events processed and failed.
# n_skipped: events with <2 photons, n_all: total pairs, n_cut: pairs after DR cut.
...
fit_func = ROOT.TF1("fit_func", "gaus(0) + pol2(3)", 0, 300)
fit_func.SetParameters(700, 135, 10, 100, -1, 0.01)
hist_all.Fit(fit_func, "R")
